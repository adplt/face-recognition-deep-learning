...
def build_model():
    ...
    conv1.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='tf', input_shape=(48, 48, 64)))
    
    conv2 = Sequential()
    
    conv2.add(Conv2D(1, (3, 3), input_shape=(48, 48, 192), data_format='channels_first'))
    conv2.add(Activation('relu'))
    conv2.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='tf', input_shape=(24, 24, 192)))
    ...
    inception3.add(Activation('relu'))
    inception3.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='tf', input_shape=(12, 12, 480)))
    ...
    inception4.add(Activation('relu'))
    inception4.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='tf', input_shape=(6, 6, 832)))
    ...
    inception5.add(Activation('relu'))
    inception4.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='tf', ))
